                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-info rounded-pill text-uppercase fw-bold">
                                        {{ number_format($chef->recipes->count(), 0) }}
                                    </span>
                                </td>
                                {{-- <td>
                                ...
                                <td>
                                    <a href="{{ route('chefs.approve', $chef->id) }}" class="btn btn-sm btn-danger">
                                        <i data-feather="x" class="icon-dual icon-xs mr-2"></i>
                                        Revoke
                                    </a>
